...
{
    fprintf(smallragLOG_OUT, "[%s] %s> %s:%s:%s: ", level_prefix, __TIME__, __FILE__, __func__, __LINE__);
}

static void log(char *level_prefix, char *msg, va_list args)
{
    print_log_meta();
